...
medicion = prompt("Hola "+ nombre_usuario+". Que quieres medir: 0-Electricidad 1-agua 2-gas 3-temperatura 4-presion 5-agregar otro");
...
if(medicion == 0){
    for(i=0; i< datosElectricos.length;i++)
        ...
        nueva_variable = []
        prompt("Has creado una nueva variable, ahora debes agregar datos: ");
